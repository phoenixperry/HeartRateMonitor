...
//            print("🔗 Connecting directly to: \(knownPeripheral.name ?? "Unknown") with UUID: \(uuid)")
//            connectToPeripheral(knownPeripheral)
//        } else {
//            print("❌ Could not find peripheral with UUID \(uuid)")
//            // Optional: fallback to scanning if needed
//            startScanning()
//        }
//    }
//    
